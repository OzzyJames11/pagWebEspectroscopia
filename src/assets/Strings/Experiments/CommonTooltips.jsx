export const COMMON_TOOLTIPS = {
    // Generic column tooltips
    "Actions": "Options available for this item",
    "Voltage": "Electrical force produced by the system (V)",
    "Current": "Flow of electricity from the system (A)",
