...
import { SUBSISTEMA1_COLUMNS, PAGE_TITLES } from '../../assets/Strings/Experiments/Subsistema1Strings.jsx';
...
const Subsistema1 = () => {
    ...
    const generarValoresAleatorios = () => ({
        ...
        [SUBSISTEMA1_COLUMNS[1]]: (Math.random() * 100).toFixed(2),
        [SUBSISTEMA1_COLUMNS[2]]: (Math.random() * 10).toFixed(2),
    ...
    const handleEliminar = (index) => {
        ...
        setDatos(nuevosDatos);
        localStorage.setItem("historicalData_subsistema1", JSON.stringify(nuevosDatos)); // Actualiza el localStorage
    };
        ...
        <Box width="90%" maxWidth="1200px" margin="auto" mt={7} mb={5}>
            ...
            <Grid container spacing={4} alignItems="flex-start">
                ...
                <Grid item xs={12} md={6}>
                    <SliderComponent value={angulo} label="Azimuth Angle" min={0} max={100} step={5} onChange={(e, newValue) => setAngulo(newValue)} />
                    <DataTable columns={SUBSISTEMA1_COLUMNS} data={datos} onDelete={handleEliminar}/>
                    <Box mt={2}>
