export const PAGE_TITLES = {
    MAIN_TITLE: "Subsystem Selection",
    DESCRIPTION: "Select a subsystem to view its details and experiments.",
    VIEW_SUBSYSTEM_BUTTON: "View Subsystem",
};
...
export const SUBSYSTEMS = [
    ...
    {
        title: "Cleaning Subsystem",
        description: "This subsystem is designed to clean the solar panels.",
        path: "/experiments/subsistema3",
    },
    {
        title: "Radiation Analysis Subsystem",
